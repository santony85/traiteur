...
CGFloat popupDimensionWidth = 700.0f;
...
- (void)makeAlertPopupView {
    ...
    CGRect rect = CGRectMake(mainScreen.bounds.size.width/2 - (popupDimensionWidth/2), mainScreen.bounds.size.height/2 - (popupDimensionHeight/2) - 200, popupDimensionWidth, popupDimensionHeight);
